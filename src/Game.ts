...
//         // TODO: remove the hard-coded value for a better one.
//         // An entity should display if it's not visible by any player.
//         return position.y >= 1500; 
//     }
//
...
//         // TODO: Emit events for the render?
//         this._entities.forEach(e => e.render());
//         this._bullets.forEach(b => b.render());
//     }
//
//     private purgeBullet(): void {
//         this._bullets = this._bullets.filter(b => !Game.shouldDispawn(b.getPosition()));
//     }
//
